...
NIXL_PORT_PREFILL=$(dyn_port DYN_VLLM_NIXL_SIDE_CHANNEL_PORT 1 20098)
NIXL_PORT_DECODE=$(dyn_port DYN_VLLM_NIXL_SIDE_CHANNEL_PORT 2 20099)
KV_PORT_PREFILL=$(dyn_port DYN_VLLM_KV_EVENT_PORT 1 20081)
KV_PORT_DECODE=$(dyn_port DYN_VLLM_KV_EVENT_PORT 2 20082)
